  ...
  sosSocket.onmessage = (event) => {
    ...
    function updateOverlay(message) {
      ...
      if (parsed.event === "game:statfeed_event") {
        ...
        const primaryTargetName = primaryTarget
          ? primaryTarget.name
          : "Unknown";
        ...
        const teamNumSecondary = secondaryTarget
          ? secondaryTarget.team_num
          : -1;
      ...
      if (parsed.event === "game:update_state") {
        ...
        for (let key in OrangeBoostMeterFillColors) {
          if (OrangeBoostMeterFillColors[key]) {
            OrangeBoostMeterFillColors[
              key
            ].style.fill = `#${OrangeColorPrimary}`;
          }
        }
      ...
      if (parsed.event === "game:update_state") {
        ...
        if (spectatedPlayer) {
          ...
          const BlueBackground1 = document.getElementById(
            "teamLeft-boost-bg-1"
          );
          const BlueBackground2 = document.getElementById(
            "teamLeft-boost-bg-2"
          );
          const BlueBackground3 = document.getElementById(
            "teamLeft-boost-bg-3"
          );
